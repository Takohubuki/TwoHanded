        ...
        <div class="item active">
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <a class="button2" href="${pageContext.request.contextPath}/items/singleitem?itemId=${mostViewed.get(0).serialNum}">查看详情 </a>
                </div>
            </div>
        </div>
        <div class="item item2">
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <a class="button2" href="${pageContext.request.contextPath}/items/singleitem?itemId=${mostViewed.get(1).serialNum}">查看详情 </a>
                </div>
            </div>
        </div>
        <div class="item item3">
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <a class="button2" href="${pageContext.request.contextPath}/items/singleitem?itemId=${mostViewed.get(2).serialNum}">查看详情 </a>
                </div>
            </div>
        </div>
    </div>
